const MoreInfo = () => (
    <svg width="18px" height="18px" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
            d="M9.063 6.563a.937.937 0 101.874 0 .937.937 0 00-1.874 0zm1.406 2.187H9.53a.157.157 0 00-.156.156v5.313c0 .086.07.156.156.156h.938c.086 0 .156-.07.156-.156V8.906a.157.157 0 00-.156-.156z"
            fill="#A5A7A9"
        />
    </svg>
);
